package com.ntschy.tsc.datasource.dynamic;
...
public class DynamicDatasourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        defaultDataSourceProperties.put("username", defaultDataSourceProperties.get("username"));
        defaultDataSourceProperties.put("password", defaultDataSourceProperties.get("password"));
        ...
        try {
            ...
            if (configs != null && configs.size() > 0) {
                for (int i = 0; i < configs.size(); i ++) {
                    ...
                    clusterDatasourceProperties.put("username", clusterDatasourceProperties.get("username"));
                    clusterDatasourceProperties.put("password", clusterDatasourceProperties.get("password"));
