package com.ntschy.tsc.datasource.aop;

import com.ntschy.tsc.datasource.annotation.DataSource;
import com.ntschy.tsc.datasource.dynamic.DynamicDataSourceContextHolder;
...
public class DynamicDataSourceAnnotationInterceptor implements MethodInterceptor {
    ...
    public Object invoke(MethodInvocation invocation) throws Throwable {
        try {
            ...
            DynamicDataSourceContextHolder.SetDataSourceRouteKey(datasource);
