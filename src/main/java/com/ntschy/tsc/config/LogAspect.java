package com.ntschy.tsc.config;

import com.alibaba.fastjson.JSONObject;
import com.ntschy.tsc.entity.base.OperationLog;
import com.ntschy.tsc.handler.OperateLogHandler;
...
public class LogAspect {
    ...
    public LogAspect(InvestmentService investmentService) {
        this.investmentService = investmentService;
    }

    @Pointcut("execution(* com.ntschy.baitong.controller..*(..))")
